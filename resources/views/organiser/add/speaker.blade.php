<x-organiser-layout>
    ...
    <x-slot name='title'>Organiser - Add Speaker</x-slot>

    <x-slot name='main'>
    <div class="container m-t-20">
    <div class="wrap-login100 p-l-40 p-r-40 p-t-40 p-b-40" style="margin-left: 25%">
        <form class="login100-form validate-form flex-sb flex-w" action="{{ route('organiser.speaker.store') }}" method="post" enctype="multipart/form-data">
            @csrf
