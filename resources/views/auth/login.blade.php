<x-guest-layout>
    <div class="mt-4 flex items-center justify-center">
        <x-input-label for="login" :value="__('User Login')" />
    </div>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="email" class="block mt-1 w-full" type="email" name="user_email" :value="old('user_email')" autofocus autocomplete="username" />
