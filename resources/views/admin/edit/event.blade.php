<x-admin-layout>
    ...
    <x-slot name='main'>
        ...
        <script>
            document.getElementById("eventDate").defaultValue = {{ $event->date }};
        </script>
    <div class="container m-t-20">
        <div class="wrap-login101 p-l-40 p-r-40 p-t-40 p-b-40" style="margin-left: 15px">
            <form class="login100-form validate-form flex-sb flex-w" action="{{ route('admin.event.update',  $event->id) }}" method="post" enctype="multipart/form-data">
                @csrf   
                @method('PUT')
